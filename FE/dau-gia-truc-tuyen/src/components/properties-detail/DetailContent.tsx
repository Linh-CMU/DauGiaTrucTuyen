...
const DetailContent: React.FC<DetailContentProps> = ({auctionDetailInfor}) => {
  ...
  <div className="mx-auto bg-white p-6 shadow-lg rounded-md w-full">
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-3">7. Thời gian, địa điểm bán, nộp tiền mua hồ sơ tham gia đấu giá:</h2>
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-3">8. Tiền bán hồ sơ tham gia đấu giá, tiền đặt trước, bước giá:</h2>
        <p className="mb-2"><span className="font-semibold">Tiền bán hồ sơ:</span> 500.000 đồng/bộ hồ sơ.</p>
        <p className="mb-2"><span className="font-semibold">Tiền đặt trước:</span> 112.000.000 đồng.</p>
        <p className="mb-4"><span className="font-semibold">Bước giá:</span> 10.000.000 đồng.</p>

        <h2 className="text-lg font-semibold text-gray-800 mb-3">9. Thời gian, địa điểm tổ chức cuộc đấu giá:</h2>
        <p className="mb-2"><span className="font-semibold">Thời gian:</span> 09:00 ngày 31/10/2024.</p>
        ...
        <h2 className="text-lg font-semibold text-gray-800 mb-3">10. Hình thức, phương thức đấu giá:</h2>
        <p className="mb-4">Đấu giá trực tuyến; Phương thức trả giá lên với thời gian 30 phút.</p>

        <h2 className="text-lg font-semibold text-gray-800 mb-3">11. Địa điểm:</h2>
