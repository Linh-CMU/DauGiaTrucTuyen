                        ...
                        <div className='w-full max-w-lg'>
                            ...
                            <div className='flex flex-wrap -mx-3 mb-6'>
                                <div className='w-full px-3 mb-6 md:mb-0'>
                                    ...
                                    {!gender && isTouched && <p className="text-red-500 text-xs italic">Vui lòng chọn giới tính .</p>}
                                </div>
                            </div>
                            <div className='flex flex-wrap -mx-3 mb-6'>
                                <div className='w-full  px-3 mb-6 md:mb-0'>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {!birthDate && isTouched && <p className="text-red-500 text-xs italic">Vio lòng chọn giới tính .</p>}
                                </div>
                            </div>
                            <div className='flex flex-wrap -mx-3 mb-6'>
                            ...
                            <div className='flex flex-wrap -mx-3 mb-6'>
                                <div className='w-full  px-3 mb-6 md:mb-0'>
                                    ...
                                    <input
                                        ...
                                        onFocus={() => setIsTouched(true)}
                                    />
                                    {!address && isTouched && <p className="text-red-500 text-xs italic">Please enter your full name.</p>}
                                </div>
                            </div>
                            ...
                            <div className='flex flex-wrap -mx-3 mb-6'>
                                <div className='w-full  px-3 mb-6 md:mb-0'>
                                    ...
                                    <input
                                        ...
                                        onFocus={() => setIsTouched(true)}
                                    />
                                    {!placeOfResidence && isTouched && <p className="text-red-500 text-xs italic">Please enter your full name.</p>}
                                </div>
                            </div>
                                ...
                                <div className='flex flex-wrap -mx-3 mb-6'>
                                    <div className='w-full  px-3 mb-6 md:mb-0'>
                                        ...
                                        <input
                                            ...
                                            onFocus={() => setIsTouched(true)}
                                        />
                                        {!placeOfIssue && isTouched && <p className="text-red-500 text-xs italic">Vui lòng nhập nơi cấp</p>}
                                    </div>
                                </div>
                                <div className='flex flex-wrap -mx-3 mb-6'>
                                    <div className='w-full  px-3 mb-6 md:mb-0'>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        {!dateOfIssue && isTouched && <p className="text-red-500 text-xs italic">Vui lòng nhập ngày cung cấp</p>}
                                    </div>
                                </div>
                                <div className='flex flex-wrap -mx-3 mb-6'>
                                    <div className='w-full  px-3 mb-6 md:mb-0'>
