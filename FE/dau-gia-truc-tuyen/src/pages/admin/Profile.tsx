                                    ...
                                    <div className='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                        <div className="flex items-center justify-center w-full">
                                                <div className="relative w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer">
                                                    <img src={`http://capstoneauctioneer.runasp.net/api/read?filePath=${profile.avatar}`} alt="Front CCCD" className="w-full h-full object-cover rounded-lg" />
                                                </div>
                                        </div> 
                                    </div>
                                    <div className='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                                        <div className="flex items-center justify-center w-full">
                                                ...
                                                <div className="relative w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer">
                                                    <img src={`http://capstoneauctioneer.runasp.net/api/read?filePath=${profile.avatar}`} alt="Back CCCD" className="w-full h-full object-cover rounded-lg" />
